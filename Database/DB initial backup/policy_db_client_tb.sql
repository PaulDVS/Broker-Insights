...
CREATE TABLE `client_tb` (
  `idclient_tb` int NOT NULL AUTO_INCREMENT,
  `client_name` varchar(45) NOT NULL,
  PRIMARY KEY (`idclient_tb`),
  UNIQUE KEY `idclient_tb_UNIQUE` (`idclient_tb`),
...
INSERT INTO `client_tb` VALUES (1,'Achme Broker Ltd');
...
-- Dump completed on 2022-08-23  2:28:18
