...
CREATE TABLE `policies_tb` (
  ...
  CONSTRAINT `client_name` FOREIGN KEY (`client_name`) REFERENCES `client_tb` (`client_name`),
  CONSTRAINT `customer_name` FOREIGN KEY (`customer_name`) REFERENCES `customer_tb` (`customer_name`)
...
INSERT INTO `policies_tb` VALUES (1,'Achme Broker Ltd','ABC Joinery',123.87,'Public Liability','Aviva'),(2,'Achme Broker Ltd','XYZ Plumbing',2321.45,'Public Liability','Allianze'),(3,'Achme Broker Ltd','Fast Taxis',59897.00,'Motor Fleet','Aviva'),(4,'Achme Broker Ltd','Fast Taxis',6845.00,'Public Liability','QBE');
...
-- Dump completed on 2022-08-23 14:38:54
